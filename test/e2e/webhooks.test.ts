...
describe("webhooks", () => {
  ...
  it("stripe payment_intent.payment_failed → cancela e devolve estoque", async () => {
  ...
  it("pagamento tardio de pedido cancelado: payment succeeded, order fica cancelled", async () => {
    const { orderId, payment } = await seedOrder(app, "stripe");
